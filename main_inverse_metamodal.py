...
file_handler = logging.FileHandler(os.path.join(args.ckpt_path, 'log_{}_inverse_{}_bs_{}_fusion_{}_metaratio_{}.txt'.format(args.modulation, args.inverse, args.batch_size, args.fusion_method, args.meta_ratio)))
...
log_name = '{}_{}_inverse_{}_bs_{}_metaratio_{}'.format(args.fusion_method, args.modulation, args.inverse, args.batch_size, args.meta_ratio)
...
def valid(args, model, device, dataloader):
    ...
    with torch.no_grad():
        ...
        for step, (spec, image, label) in enumerate(dataloader):
            ...
            if args.fusion_method == 'inverse_metamodal':
...
def main():
    ...
    if args.inverse is True and args.meta_ratio > 0.0:
        args.fusion_method = 'inverse_metamodal'
